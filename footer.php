<div class="container">
    <footer class="py-5">
        <div class="row">
            <div class="col-6 col-md-2 mb-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2"><a href="seance.php" class="nav-link p-0 text-body-secondary">Séance</a></li>
                    <li class="nav-item mb-2"><a href="about.php" class="nav-link p-0 text-body-secondary">A propos</a></li>
                </ul>
            </div>
            <div class="col-md-5 offset-md-1 mb-3">
                <form>
                    <h5>S'abonner à notre page</h5>
                    <p>Restez informez des dernières sorties us.</p>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
            <p>&copy; 2025 IPNET, Inc. All rights reserved.</p>
